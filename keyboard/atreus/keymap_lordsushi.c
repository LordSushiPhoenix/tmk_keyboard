/*
This layout was created by modifying Jeremy Cowgar's (@jcowgar) layout. Jeremy who is a programmer by trade
...
#define GAME 11 // a gaming layer without momentary layer keys
...
//#define KM_SAVE ACTION_MODS_KEY(MOD_LCTRL, KEY_SAVE)    // Colemak to Qwerty in software playing games
//#define KM_CLSE ACTION_MODS_KEY(MOD_LCTRL, KEY_CLSE)
//#define KM_OPEN ACTION_MODS_KEY(MOD_LCTRL, KEY_OPEN) // Colemak to Qwerty in software playing games
//#define KM_COPY ACTION_MODS_KEY(MOD_LCTRL, KC_C)
//#define KM_CUT  ACTION_MODS_KEY(MOD_LCTRL, KC_X)
//#define KM_PAST ACTION_MODS_KEY(MOD_LCTRL, KC_V)
//#define KM_UNDO ACTION_MODS_KEY(MOD_LCTRL, KC_Z)
...
[ALPH] = {
  ...
  {KC_LCTRL, KC_LGUI, KC_LALT, KC_DEL, KC_LSFT, KC_SPC, KC_RSFT, KC_ENT, KC_RALT, KC_TAB, KC_ESC}
},
[NUMS] = {
...
[FKEY] = {
  {FN_GAME, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12},
...
[CURS] = {
  {KC_TRNS, KC_BSPC, KC_UP,   KC_DEL,  KC_PGUP, KC_TRNS, KC_HOME, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_TRNS, KC_END, KC_LALT, KC_TRNS, KC_LGUI, KC_TRNS},
  {KC_TRNS, KC_VOLD, KC_MUTE, KC_VOLU, KC_MPLY, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS},
  {KC_TRNS, KC_TRNS, FN_BOOT, KC_TRNS, KC_TAB,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS}
},
[SYMB] = {
...
[GAME] = {
  {KC_TAB,     KC_Q,    KC_W,    KC_E,    KC_R,    KC_TRNS, KC_T,    KC_Y,    KC_U,    KC_I,    KC_O},
  {KC_LCTRL,   KC_A,    KC_S,    KC_D,    KC_F,    KC_TRNS, KC_G,    KC_H,    KC_J,    KC_K,    KC_L},
  {KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_BSPC, KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT},
  {KC_1,       KC_2,    KC_3,    KC_4,    KC_LALT, KC_SPC,  KC_RSFT, KC_ENT,  FN_GAME, KC_F5, KC_ESC}
}};
